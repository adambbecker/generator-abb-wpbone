...
function <%= _.slugify(fnPrefix) %>_enqueues() {
	...
	/*
wp_register_script('example', get_template_directory_uri() . '/dist/scripts/example.js', array('example_dependency'), '0.0.1', true);
	// Last argument puts script in wp_footer() instead of wp_head()
*/

	/* Javascript - enqueues -----------------------------------------------------*/
	include_once(get_template_directory() . '/footer_include.php');
